  ...
  if (env === DEVELOPMENT) {
    return merge(
      [
        ...
        // The `type` parameter governs the type of sourcemap generated. `eval-source-map` is slow
        // to build, but faster to rebuild and is very accurate. For faster build and rebuild, but
        // less accuracy (lines only) `cheap-eval-source-map` can be used.
